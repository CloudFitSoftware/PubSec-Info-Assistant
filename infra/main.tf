...
module "storage" {
  ...
  containers = ["content", "website", "upload", "function", "logs", "config", "assets"]
...
module "functions" {
  ...
  azureSearchServiceEndpoint            = var.disconnectedAi ? "" : module.searchServices[0].endpoint
  ...
  acrEndpoint                           = var.containerizedAppServices ? module.acr[0].endpoint : ""
  imageName                             = var.containerizedAppServices ? "function" : ""
  imageTag                              = var.containerizedAppServices ? "latest" : ""
...
module "openAiRoleBackend" {
  ...
  principalId      = var.containerizedAppServices ? module.aks[0].kubletId : module.backend[0].identityPrincipalId
